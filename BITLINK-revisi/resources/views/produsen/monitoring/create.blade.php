    ...
    <section class="tambah-bibit section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <!-- Tambah Bibit Inner -->
                    <form method="POST" action="{{ route('produsen.laporan.store') }}">
                        @csrf
                        {{-- <input type="hidden" value="{{Auth::user()->id}}" name="id_akunp"> --}}
                        <div class="mb-3">
                            <label for="tgl_evaluasi" class="form-label">Tanggal Evaluasi</label>
                            <input type="date" id="tgl_evaluasi" name="tgl_evaluasi" class="form-control" placeholder="Masukkan tanggal evaluasi">
                        </div>
                        <div class="mb-3">
                            <label for="nama_perusahaan" class="form-label">Nama Perusahaan</label>
                            <input type="text" id="nama_perusahaan" name="nama_perusahaan" class="form-control" value="{{Auth::user()->dataProdusen->nama_perusahaan}}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="kinerja_produksi" class="form-label">Kinerja Produksi</label>
                            <input type="text" id="kinerja_produksi" name="kinerja_produksi" class="form-control" placeholder="Masukkan kinerja produksi">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="kendala_produksi" name="kendala_produksi" class="form-control" placeholder="Masukkan kendala produksi">
                        </div>
                        <div class="mb-3">
                            <label for="saran_produksi" class="form-label">Saran Perbaikan</label>
                            <input type="text" id="saran_produksi" name="saran_produksi" class="form-control" placeholder="Masukkan saran perbaikan">
                        </div>
